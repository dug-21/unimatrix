//! Session lifecycle persistence for SQLite backend.
//!
//! SQLite equivalent of the redb sessions.rs module. Provides CRUD operations
//! on the sessions table and GC logic with injection_log cascade deletion.

use rusqlite::OptionalExtension;

use crate::error::{Result, StoreError};
use crate::sessions::{
    GcStats, SessionLifecycleStatus, SessionRecord,
};

use super::db::Store;

/// Serialize a SessionRecord to bytes using bincode.
