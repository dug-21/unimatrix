...
async fn run_main_migrations(
    ...
    if current_version < 24 {
        ...
        // Pattern: all pre-checks before any ALTER (from v20→v21 block).
        ...
        let has_corrections_total: bool = sqlx::query_scalar::<_, i64>(
        ...
        let has_corrections_agent: bool = sqlx::query_scalar::<_, i64>(
            "SELECT COUNT(*) FROM pragma_table_info('cycle_review_index')
        ...
        let has_corrections_human: bool = sqlx::query_scalar::<_, i64>(
            "SELECT COUNT(*) FROM pragma_table_info('cycle_review_index')
        ...
        let has_corrections_system: bool = sqlx::query_scalar::<_, i64>(
            "SELECT COUNT(*) FROM pragma_table_info('cycle_review_index')
        ...
        let has_deprecations_total: bool = sqlx::query_scalar::<_, i64>(
            "SELECT COUNT(*) FROM pragma_table_info('cycle_review_index')
        ...
        let has_orphan_deprecations: bool = sqlx::query_scalar::<_, i64>(
            "SELECT COUNT(*) FROM pragma_table_info('cycle_review_index')
        ...
        let has_first_computed_at: bool = sqlx::query_scalar::<_, i64>(
            "SELECT COUNT(*) FROM pragma_table_info('cycle_review_index')
