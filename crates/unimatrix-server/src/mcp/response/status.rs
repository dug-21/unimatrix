...
pub struct StatusReport {
    ...
    // bugfix-891 (#891): the `stale_dependency_edges` field (vnc-015, AC-11) was retired — the
    // metric was structurally starved and reported the wrong direction. Follow-up signal: #895.
}
...
struct StatusReportJson {
    ...
    // bugfix-891 (#891): stale_dependency_edges retired from the status JSON. Follow-up: #895.
}
