...
2. **Read the active roadmap**: `product/research/ass-032/ROADMAP.md` — full file
...
| Store knowledge in Unimatrix | This is a read-only relationship with the knowledge base |
...
There is no formal close. When the human is done, they will end the session. If you have updated the vision doc or created issues during the session, give a brief summary of what changed before the human leaves.
