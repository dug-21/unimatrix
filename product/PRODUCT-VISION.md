...
**Status (2026-03-05):** col-001 ✅, col-002 ✅, col-002b ✅, col-006 ✅, col-007 ✅, col-008 ✅ (#69, PR #72), col-009 ✅, col-010 ✅, col-010b ✅. **All hook-driven delivery features complete.** col-003/004 unscoped. col-005 blocked until 5+ feature retrospectives accumulated. col-011 unscoped.

**Unscoped — Retrospective Pipeline v2 (structured audit data):** The retrospective pipeline (col-002/002b) currently analyzes passive JSONL telemetry from observation hooks. Meanwhile, the active hook infrastructure (col-009, col-010) and service layer (vnc-006–009) now write significantly richer structured data to AUDIT_LOG, INJECTION_LOG, SIGNAL_QUEUE, and SESSIONS tables — usage patterns, confidence signals, rate limit violations, auth failures, session lifecycles. No feature currently scopes evolving col-002's analysis engine to query these structured tables instead of (or alongside) JSONL parsing. col-010's `from_structured_events()` partially bridges session detection but does not extend to the full analysis pipeline. **Dependency satisfied**: nxs-008 (Schema Normalization) normalized all 7 tables to SQL columns — entry effectiveness scoring via `INJECTION_LOG JOIN SESSIONS JOIN ENTRIES` is now trivial. See `product/research/ass-016/retrospective-data-architecture.md` for the Tier 1–2 analytics roadmap.
