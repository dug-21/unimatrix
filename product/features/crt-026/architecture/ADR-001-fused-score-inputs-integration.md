...
- The sum-invariant concern (the six-term sum was `<= 1.0`; adding `w_phase_histogram=0.02`
  brings the total to `0.97`) is resolved cleanly: the existing validation in
